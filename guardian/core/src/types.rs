...
/// One recipient detail of a transfer.
#[derive(Debug, Serialize, Deserialize)]
...
mod tests {
    ...
    /// Must match `guardian_tests::transfer_request_payload_serde`.
    #[test]
    fn transfer_payload_matches_move() {
        ...
        assert_eq!(
            ...
            ""
        );
    }
