...
/// previous) that verified this transfer's auditor proofs — so an auditor knows which index carries
/// its handles. `memo` is an opaque caller-supplied blob, empty if none was provided.
