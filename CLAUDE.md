...
- **U64 amounts encoded as four u16 limbs** to prevent overflow when adding encrypted values; a `AccumulatedAmount` tracks a count of merged u16-bounded values that bounds limb growth so it stays decryptable
